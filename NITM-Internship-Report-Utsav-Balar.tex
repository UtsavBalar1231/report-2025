...
% TODO: Add Distiller Alpha product image
% \begin{figure}[h]
%     \centering
...
% TODO: Add Distiller BHV product image
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.7\textwidth]{distiller_bhv.png}
%     \caption{Distiller BHV - AI Device for Bio Hacking Village}
% \end{figure}

\vspace{0.5cm}

% TODO: Add Distiller Air product image
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.7\textwidth]{distiller_air.png}
